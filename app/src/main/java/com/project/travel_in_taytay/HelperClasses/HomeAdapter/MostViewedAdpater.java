...
public class MostViewedAdpater<MostViewedViewedHolder> extends RecyclerView.Adapter<MostViewedAdpater.MostViewedViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MostViewedViewHolder holder, int position) {
        ...
        holder.titleView.setText(helperClass.getTitleView());
        holder.descView.setText(helperClass.getDescView());
    }
